...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('sc_shop_customer', function (Blueprint $table) {
            if (Schema::hasColumn('sc_shop_customer', 'province')) {
                $table->dropColumn('province');
            }
            if (Schema::hasColumn('sc_shop_customer', 'regency')) {
                $table->dropColumn('regency');
            }
            if (Schema::hasColumn('sc_shop_customer', 'district')) {
                $table->dropColumn('district');
            }
            if (Schema::hasColumn('sc_shop_customer', 'subdistrict')) {
