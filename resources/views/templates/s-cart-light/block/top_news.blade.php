...
@if ($news->count())
<!-- START SECTION NEWS -->
  <section class="section" style="margin: 50px 0 20px 0; margin-top: 80px">
    <div class="container">
      <h2 class="wow fadeScale" style="font-family: 'Poppins', sans-serif; font-size: 30px; color:rgb(13, 101, 195); text-transform: none; margin-bottom: 20px;"><b>{{ sc_language_render('front.blog') }}</b></h2>
