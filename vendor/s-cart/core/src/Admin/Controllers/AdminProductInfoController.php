...
use SCart\Core\Admin\Models\AdminProductInfo;
...
class AdminProductInfoController extends RootAdminController
{
    ...
    public function index()
    {
        ...
        $data = [
            ...
            'subTitle'      => '',
            'icon'          => 'fa fa-indent',
            'urlDeleteItem' => sc_route_admin('admin_product_info.delete'),
        ...
        $dataTmp = (new AdminProductInfo)->getProductListAdmin($dataSearch);
        $arrProductId = $dataTmp->pluck('id')->toArray();
        $categoriesTmp = (new AdminProductInfo)->getListCategoryIdFromProductId($arrProductId);
        ...
        foreach ($dataTmp as $key => $row) {
            ...
            $htmlAction = '
            <a href="' . sc_route_admin('admin_product_info.edit', ['id' => $row['id'] ? $row['id'] : 'not-found-id']) . '">
        ...
        //menuRight
        $data['menuRight'][] = '<a href="' . sc_route_admin('admin_product_info.create') . '" class="btn btn-success btn-flat" title="'.sc_language_render('product.admin.add_new_title').'" id="button_create_new">
        <i class="fa fa-plus"></i>
        </a>';
        if (sc_config_admin('product_kind')) {
            $data['menuRight'][] = '<a href="' . sc_route_admin('admin_product_info.build_create') . '" class="btn btn-success btn-flat" title="'.sc_language_render('product.admin.add_new_title_build').'" id="button_create_new">
            <i class="fas fa-puzzle-piece"></i>
            </a>';
            $data['menuRight'][] = '<a href="' . sc_route_admin('admin_product_info.group_create') . '" class="btn btn-success btn-flat" title="'.sc_language_render('product.admin.add_new_title_group').'" id="button_create_new">
        ...
        //topMenuRight
        $data['topMenuRight'][] ='
                <form action="' . sc_route_admin('admin_product_info.index') . '" id="button_search">
    ...
    public function create()
    {
        ...
        return view($this->templatePathAdmin.'screen.product_info_add')
            ->with($data);
    }
    ...
    public function createProductBuild()
    {
        ...
        $listProductSingle = (new AdminProductInfo)->getProductSelectAdmin(['kind' => [SC_PRODUCT_SINGLE]]);
        ...
        return view($this->templatePathAdmin.'screen.product_info_add_build')
        ->with($data);
    }
    ...
    public function createProductGroup()
    {
        ...
        return view($this->templatePathAdmin.'screen.product_info_add_group')
        ->with($data);
    }
    ...
    public function postCreate()
    {
        ...
        $dataCreate = [
            ...
            'alias'          => Str::startsWith($data['sku'], 'INF-') ? $data['sku'] : 'INF-' . $data['sku'],
        ...
        $product = AdminProductInfo::createProductAdmin($dataCreate);
        ...
        AdminProductInfo::insertDescriptionAdmin($dataDes);
        ...
        return redirect()->route('admin_product_info.index')->with('success', sc_language_render('product.admin.create_success'));
    }
    ...
    */
    ...
    {
        $product = (new AdminProductInfo)->getProductAdmin($id);
        ...
        return view($this->templatePathAdmin.'screen.product_info_edit')
            ->with($data);
    }
    ...
    public function postEdit($id)
    {
        ...
        return redirect()->route('admin_product_info.index')->with('success', sc_language_render('product.admin.edit_success'));
    }
    ...
    */
    public function deleteList()
    {
        if (!request()->ajax()) {
            ...
            if ($arrDelete) {
                AdminProductInfo::destroy($arrDelete);
                sc_clear_cache('cache_product');
            }
    ...
    {
        return (new AdminProductInfo)->getProductAdmin($id);
    }
    ...
    public function cloneProductInfo() {
        ...
        $pId = request('pId');
        $product = AdminProductInfo::find($pId);
        if (!$product) {
        ...
        try {
            ...
            $newProduct = AdminProductInfo::create($dataProduct);
