...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header with-border">
                ...
                <div class="card-tools">
                    <div class="btn-group float-right mr-5">
                        <a target=_new href="{{ sc_route_admin('admin_product_info.index') }}" class="btn  btn-flat btn-default" title="List">
            ...
            <!-- form start -->
            <form action="{{ sc_route_admin('admin_product_info.create') }}" method="post" name="form_name" accept-charset="UTF-8" 
                ...
                <div id="main-add" class="card-body">
                        ...
                        <div class="form-group row d-none">
                            <textarea id="{{ $code }}__description"
                                ...
                                hidden>{{ old('descriptions.'.$code.'.description', 'deskripsi') }}</textarea>
                        </div>
...
@endif
                        ...
                        {{-- isbn --}}
                        <div class="form-group row kind  {{ $errors->has('isbn') ? ' text-red' : '' }}">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" style="width: 100px;" id="isbn" name="isbn"
                                        value="{!! old('isbn')??'' !!}" class="form-control input-sm isbn"
                                        placeholder="" />
                                </div>
                            </div>
                        </div>
                        ...
                        {{-- eisbn --}}
                        <div class="form-group row kind  {{ $errors->has('eisbn') ? ' text-red' : '' }}">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" style="width: 100px;" id="eisbn" name="eisbn"
                                        value="{!! old('eisbn')??'' !!}" class="form-control input-sm eisbn"
                                        placeholder="" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" style="width: 100px;" id="writer" name="writer"
                                        value="{!! old('writer')??'' !!}" class="form-control input-sm writer"
                                        placeholder="" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="number" style="width: 100px;" id="page" name="page"
                                        value="{!! old('page')??0 !!}" class="form-control input-sm page"
                                        placeholder="" />
                                </div>
                                @if ($errors->has('page'))
                                <span class="form-text">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="number" style="width: 100px;" id="year" name="year"
                                        value="{!! old('year')??0 !!}" class="form-control input-sm year"
                                        placeholder="" />
                                </div>
                                @if ($errors->has('year'))
                                <span class="form-text">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" style="width: 100px;" id="edition" name="edition"
                                        value="{!! old('edition')??'' !!}" class="form-control input-sm edition"
                                        placeholder="" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" style="width: 100px;" id="city" name="city"
                                        value="{!! old('city')??'' !!}" class="form-control input-sm city"
                                        placeholder="" />
                                </div>
                            </div>
                        </div>
