...
class ShopOrder extends Model
{
    ...
    public function createOrder($dataOrder, $dataTotal, $arrCartDetail)
    {
        ...
        try {
            ...
            $payment_metode = $dataOrder['payment_method'];
            $return = ['error' => 0, 'orderID' => $orderID, 'msg' => "", 'detail' => $order, 'va_number' => $va_number, 'expired_date' => $now, 'payment_metode' => $payment_metode];
        } catch (\Throwable $e) {
            DB::connection(SC_CONNECTION)->rollBack();
