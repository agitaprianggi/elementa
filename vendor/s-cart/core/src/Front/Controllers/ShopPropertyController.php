...
class ShopPropertyController extends RootFrontController
{
    ...
    /**
     * Process front get all property
     *
     * @param [type] ...$params
     * @return void
     */
    public function allPropertiesProcessFront(...$params)
    {
